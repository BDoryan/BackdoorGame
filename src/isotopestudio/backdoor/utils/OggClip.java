...
public class OggClip {
	...
	public final int BUFSIZE = 4096 * 2;
	public int convsize = BUFSIZE * 2;
	public byte[] convbuffer = new byte[convsize];
	public SyncState oy;
	...
	public int rate;
	public int channels;
	public BufferedInputStream bitStream=null;
	 ...
	 */
	public void initJavaSound(int channels, int rate) {
		try {
	...
	public AtomicBoolean played = new AtomicBoolean(false);
